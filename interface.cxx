...
//additional button for this assignment
Fl_Button *selectFrame_button = (Fl_Button *)0;
Fl_Button *displayNextFrame_button = (Fl_Button *)0;
Fl_Button *displayPrevFrame_button = (Fl_Button *)0;
Fl_Light_Button *toggleOriginFrame_button = (Fl_Light_Button *)0;
Fl_Output *numFrames_output = (Fl_Output *)0;
Fl_Value_Input *tValue_input = (Fl_Value_Input *)0;
...
Fl_Window* make_window() {
  ...
  { Fl_Window* o = main_window = new Fl_Window(741, 622, "Acclaim file player");
	...
	//additional buttons
	{
		Fl_Output *o = numFrames_output = new Fl_Output(515, 500, 30, 25, "");
		o->value("0");
	}
	{
		Fl_Button* o = selectFrame_button = new Fl_Button(415, 495, 90, 40, "Select Frame");
		o->callback((Fl_Callback*)selectFrame_callback, (void*) numFrames_output);
	}
	{
		Fl_Button* o = displayPrevFrame_button = new Fl_Button(548, 500, 20, 20, "<");
		o->callback((Fl_Callback*)displayFrame_callback, (void*)-1);
	}
	{
		Fl_Button* o = displayNextFrame_button = new Fl_Button(568, 500, 20, 20, ">");
		o->callback((Fl_Callback*)displayFrame_callback, (void*)1);
	}
	{
		Fl_Light_Button* o = toggleOriginFrame_button = new Fl_Light_Button(215, 495, 75, 25, "Original");
		o->callback((Fl_Callback*)toggleOriginFrame_callback);
	}
	{
		Fl_Value_Input* o = tValue_input = new Fl_Value_Input(450, 585, 50, 30, "t value:");
		o->value(0.5);	//t value is 0.5 by default
	}
      ...
      { Fl_Button* o = interpolate_button = new Fl_Button(425, 545, 75, 40, "Interpolate");
		o->callback((Fl_Callback*)interpolate_callback, (void*)tValue_input);
      }
